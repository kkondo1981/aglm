...
#' @param ... Other arguments are passed directly to backend (currently `glmnet()` is used), and if not given, default values of the backend API are used to call backend functions.
#'
